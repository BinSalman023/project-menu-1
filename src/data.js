...
export const MENU_ITEMS = [
    ...
    {
        id: 207, categoryId: 'bati_porsiyon', price: 315, image: '/images/Chicken-burger-meal.jpg', name: { ar: 'وجبة برجر دجاج', tr: 'Tavuk Burger Porsiyon', en: 'Chicken Burger Meal' }, description: { ar: 'برغر دجاج مشوي يقدم داخل خبز البرغر الطازج مع الخس والطماطم والبطاطا.', tr: 'Tavuk burger menü, patates kızartması ile.', en: 'Grilled chicken burger served in fresh bun with lettuce, tomato, and fries.' },
        optionGroups: [
    ...
    {
        id: 210, categoryId: 'bati_porsiyon', price: 345, image: '/images/Beef-burger-meal.jpg', name: { ar: 'وجبة برجر لحم', tr: 'Et Burger Porsiyon', en: 'Beef Burger Meal' }, description: { ar: 'برغر لحم بقري صافي مشوي على اللهب، يقدم مع صوص البرغر الخاص والبطاطا المقلية.', tr: 'Dana eti burger menü, patates kızartması ile.', en: 'Flame-grilled pure beef burger, served with special burger sauce and fries.' },
        optionGroups: [
            { id: 'main', name: { ar: 'الطلب الرئيسي', tr: 'Ana Seçim', en: 'Main Selection' }, options: [{ id: 'reg', name: { ar: 'عادي', tr: 'Normal', en: 'Regular' }, price: 0 }] },
            { id: 'cheese', name: { ar: 'إضافة جبنة', tr: 'Peynir', en: 'Extra Cheese' }, options: [{ id: 'no', name: { ar: 'بدون جبنة', tr: 'Peynirsiz', en: 'No Cheese' }, price: 0 }, { id: 'yes', name: { ar: 'مع جبنة', tr: 'Kaşarlı', en: 'With Cheese' }, price: 20 }] }
        ]
    ...
    { id: 303, categoryId: 'bati_sandvic', price: 200, image: '/images/Beef-burger.jpg', name: { ar: 'ساندويش برجر لحم', tr: 'Et Hamburger Sandviç', en: 'Beef Burger Sandwich' }, description: { ar: 'ساندويش برجر لحم بقري محضر يدوياً مع الخضروات الطازجة وصوصنا الخاص.', tr: 'Ev yapımı dana burger sandviç.', en: 'Handmade beef burger sandwich with fresh vegetables and special sauce.' }, optionGroups: [{ id: 'cheese', name: { ar: 'إضافة جبنة', tr: 'Peynir', en: 'Cheese' }, options: [{ id: 'no', name: { ar: 'بدون جبنة', tr: 'Peynirsiz', en: 'No Cheese' }, price: 0 }, { id: 'yes', name: { ar: 'مع جبنة', tr: 'Kaşarlı', en: 'With Cheese' }, price: 20 }] }] },
    { id: 304, categoryId: 'bati_sandvic', price: 180, image: '/images/Chicken-burger.jpg', name: { ar: 'ساندويش برجر دجاج', tr: 'Tavuk Burger Sandviç', en: 'Chicken Burger Sandwich' }, description: { ar: 'ساندويش برغر دجاج كلاسيكي مع صوص المايونيز والجبن والخضروات.', tr: 'Tavuk burger sandviç.', en: 'Classic chicken burger sandwich with mayo, cheese, and vegetables.' }, optionGroups: [{ id: 'cheese', name: { ar: 'إضافة جبنة', tr: 'Peynir', en: 'Cheese' }, options: [{ id: 'no', name: { ar: 'بدون جبنة', tr: 'Peynirsiz', en: 'No Cheese' }, price: 0 }, { id: 'yes', name: { ar: 'مع جبنة', tr: 'Kaşarlı', en: 'With Cheese' }, price: 20 }] }] },
    {
